 ...
 * Implements hook_theme().
 ...
 drupal_add_js(drupal_get_path('theme', 'shopwiz') . 'js/shopwiz.behaviors.js', 'file', 'header', 'JS_THEME');
 ...
 if (isset($_SESSION['messages']['commerce-add-to-cart-confirmation'])) {
    ...
    $vars['commerce_add_to_cart_confirmation_messages'] = array(
      '#type' => 'container',
      '#attributes' => array('class' => array('messages add-cart-message-wrapper commerce-add-to-cart-confirmation commerce_add_to_cart_confirmation_overlay')),
      'content' => array(
        '#type' => 'markup',
        '#markup' => $markup)
    );
